        ...
        <section class="container">
            ...
            if (isset($_GET['country'])) {
                ...
                if ($selectedLanguage) {
                    ...
                    echo '<a class="difficulty-btn cta" href="beginner.php?country=' . urlencode($selectedLanguage['country']) . '&difficulty=débutant">En savoir plus</a>';
                    echo '</div>';
                    echo '<div class="difficulty-box">';
                    ...
                    echo '<a class="difficulty-btn cta" href="intermediate.php?country=' . urlencode($selectedLanguage['country']) . '&difficulty=intermédiaire">En savoir plus</a>';
                    echo '</div>';
                    echo '<div class="difficulty-box">';
                    ...
                    echo '<a class="difficulty-btn cta" href="expert.php?country=' . urlencode($selectedLanguage['country']) . '&difficulty=expert">En savoir plus</a>';
                    echo '</div>';
                } else {
